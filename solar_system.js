...
function start()
{
    document.getElementById("start").innerHTML = "System is listening please speak<br>(Refresh page to try again)"; 
    recognition.start();
} 
...
recognition.onresult = function(event) {
 ...
 {
     show_sun = "set";
    document.getElementById("start").innerHTML = "Details About The Sun <br>(Refresh page to retry or Speak for another planet)" ;
 }
 if(content == "mercury" || content == "Mercury")
 {
     show_mercury = "set";
    document.getElementById("start").innerHTML = "Details About The Mercury <br>(Refresh page to retry or Speak for another planet) " ;
 }
 if(content == "venus" || content == "Venus")
 {
     show_venus = "set";
    document.getElementById("start").innerHTML = "Details About The Venus <br>(Refresh page to retry or Speak for another planet) " ;
 }
 if(content == "earth" || content == "Earth")
 {
     show_earth = "set";
    document.getElementById("start").innerHTML = "Details About The Earth <br>(Refresh page to retry or Speak for another planet)" ;
 }
 if(content == "mars" || content == "Mars" || content == "mass"  || content == "Marg")
 {
     show_mars = "set";
    document.getElementById("start").innerHTML = "Details About The Mars <br>(Refresh page to retry or Speak for another planet)" ;
 }
 if(content == "jupiter" || content == "Jupiter")
 {
     show_jupiter = "set";
    document.getElementById("start").innerHTML = "Details About The Jupiter <br>(Refresh page to retry or Speak for another planet)" ;
 }
 if(content == "saturn" || content == "Saturn")
 {
     show_saturn = "set";
    document.getElementById("start").innerHTML = "Details About The Saturn <br>(Refresh page to retry or Speak for another planet) " ;
 }
 if(content == "uranus" || content == "Uranus")
 {
     show_uranus = "set";
    document.getElementById("start").innerHTML = "Details About The Uranus <br>(Refresh page to retry or Speak for another planet) " ;
 }
 if(content == "neptune" || content == "Neptune")
 {
     show_neptune = "set";
    document.getElementById("start").innerHTML = "Details About The  Neptune <br>(Refresh page to retry or Speak for another planet) " ;
 }
}
